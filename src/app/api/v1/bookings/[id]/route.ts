...
export async function GET(
  ...
  // Admin client: SELECT is restricted to service_role in RLS
  ...
  if (error) {
    ...
    logger.error('[GET /api/v1/bookings/:id]', { error: error.message })
...
export async function PATCH(
  ...
  // Fetch current booking to record from_status and get user details for email
